...
export default function SettingCookieModal() {
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#02344a] p-6 text-left align-middle shadow-xl transition-all">
            ...
            <div className="mt-2">
              <p className="text-sm text-white">
                We use cookes to ensure you get the best experience on our website.
                To learn more about cookies please read our <span className='text-[#269eef]'>Cookies Policy</span>.
              </p>
            </div>
