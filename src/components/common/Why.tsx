    ...
    <div className="m-auto sm:pb-[90px]">
      ...
      <div className="flex h-full items-center justify-center sm:justify-evenly flex-col mx-10 gap-5 sm:gap-28 sm:flex-row">
        <div className="text-white font-sans max-w-2xl order-2 space-y-3">
          ...
          <p className="text-xl text-center sm:text-start leading-7">Take a listen to some of the exceptional individuals that have been through the mentor program. Hear what they have to say about the process and the people.
